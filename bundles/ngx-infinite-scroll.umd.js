(function (global, factory) {
	...
	(factory((global.ng = global.ng || {}, global.ng.ngxInfiniteScroll = global.ng.ngxInfiniteScroll || {}),global.ng.core,global.Rx,global.rxjs_operators));
...
function createScroller(config) {
    ...
    return attachScrollEvent(options)
        .pipe(rxjs_operators.mergeMap(function (ev) { return rxjs.of(calculatePoints(element, resolver)); }), rxjs_operators.map(function (positionStats) { return toInfiniteScrollParams(scrollState.lastScrollPosition, positionStats, distance); }), rxjs_operators.map(function (_a) {
        var stats = _a.stats, scrollDown = _a.scrollDown;
        updateScrollState(scrollState, stats.scrolled, stats.totalToScroll);
        return { stats: stats, scrollDown: scrollDown };
        ...
        return { scrollDown: scrollDown, stats: { totalToScroll: totalToScroll } };
...
function attachScrollEvent(options) {
    var /** @type {?} */ obs = rxjs.fromEvent(options.container, 'scroll');
