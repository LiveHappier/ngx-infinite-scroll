...
function createScroller(config) {
    ...
    return attachScrollEvent(options)
        .pipe(mergeMap(function (ev) { return of(calculatePoints(element, resolver)); }), map(function (positionStats) { return toInfiniteScrollParams(scrollState.lastScrollPosition, positionStats, distance); }), map(function (_a) {
